...
const (
	...
	LPLVDS   CR = 0x01 << 10 //+ Low-Power Regulator Low Voltage Scaling in Stop mode.
	MRLVDS   CR = 0x01 << 11 //+ Main regulator Low Voltage Scaling in Stop mode.
...
const (
	...
	UDRDY   CSR = 0x03 << 18 //+ Under Drive ready.
)
