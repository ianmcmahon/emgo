...
const (
	...
	IL20   IMR = 0x01 << 20    //+ Interrupt Mask on line 20.
	IL21   IMR = 0x01 << 21    //+ Interrupt Mask on line 21.
	IL22   IMR = 0x01 << 22    //+ Interrupt Mask on line 22.
	IMRALL IMR = 0x7FFFFF << 0 //  Interrupt Mask All.
)
...
const (
	...
	EL20 EMR = 0x01 << 20 //+ Event Mask on line 20.
	EL21 EMR = 0x01 << 21 //+ Event Mask on line 21.
	EL22 EMR = 0x01 << 22 //+ Event Mask on line 22.
)
...
const (
	...
	TR20 RTSR = 0x01 << 20 //+ Rising trigger event configuration bit of line 20.
	TR21 RTSR = 0x01 << 21 //+ Rising trigger event configuration bit of line 21.
	TR22 RTSR = 0x01 << 22 //+ Rising trigger event configuration bit of line 22.
)
...
const (
	...
	TF20 FTSR = 0x01 << 20 //+ Falling trigger event configuration bit of line 20.
	TF21 FTSR = 0x01 << 21 //+ Falling trigger event configuration bit of line 21.
	TF22 FTSR = 0x01 << 22 //+ Falling trigger event configuration bit of line 22.
)
...
const (
	...
	SWI20 SWIER = 0x01 << 20 //+ Software Interrupt on line 20.
	SWI21 SWIER = 0x01 << 21 //+ Software Interrupt on line 21.
	SWI22 SWIER = 0x01 << 22 //+ Software Interrupt on line 22.
)
...
const (
	...
	PIF20 PR = 0x01 << 20 //+ Pending bit for line 20.
	PIF21 PR = 0x01 << 21 //+ Pending bit for line 21.
	PIF22 PR = 0x01 << 22 //+ Pending bit for line 22.
)
