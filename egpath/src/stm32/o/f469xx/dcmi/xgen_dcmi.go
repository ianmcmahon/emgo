...
func (p *DCMI_Periph) OUTEN() RMCR {
	return RMCR{mmio.UM32{&p.CR.U32, uint32(OUTEN)}}
}
...
func (p *DCMI_Periph) BSM_0() RMCR {
	return RMCR{mmio.UM32{&p.CR.U32, uint32(BSM_0)}}
}

func (p *DCMI_Periph) BSM_1() RMCR {
	return RMCR{mmio.UM32{&p.CR.U32, uint32(BSM_1)}}
}
