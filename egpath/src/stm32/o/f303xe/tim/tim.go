...
const (
	...
	B2G  EGR = 0x01 << 8 //+ Break Generation.
)
...
const (
	...
	BKE  BDTR = 0x01 << 12 //+ Break enable for Break1.
	BKP  BDTR = 0x01 << 13 //+ Break Polarity for Break1.
...
const (
	...
	OC6M  CCMR3 = 0x1007 << 12 //+ OC6M[2:0] bits (Output Compare 6 Mode).
