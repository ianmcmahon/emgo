...
func (p *DSI_Periph) CR_EN() RMCR {
	return RMCR{mmio.UM32{&p.CR.U32, uint32(CR_EN)}}
}
...
func (p *DSI_Periph) LVCIDR_VCID() RMLVCIDR {
	return RMLVCIDR{mmio.UM32{&p.LVCIDR.U32, uint32(LVCIDR_VCID)}}
}
...
func (p *DSI_Periph) LCOLCR_COLC() RMLCOLCR {
	return RMLCOLCR{mmio.UM32{&p.LCOLCR.U32, uint32(LCOLCR_COLC)}}
}

func (p *DSI_Periph) LCOLCR_COLC1() RMLCOLCR {
	return RMLCOLCR{mmio.UM32{&p.LCOLCR.U32, uint32(LCOLCR_COLC1)}}
}

func (p *DSI_Periph) LCOLCR_COLC2() RMLCOLCR {
	return RMLCOLCR{mmio.UM32{&p.LCOLCR.U32, uint32(LCOLCR_COLC2)}}
}

func (p *DSI_Periph) LCOLCR_COLC3() RMLCOLCR {
	return RMLCOLCR{mmio.UM32{&p.LCOLCR.U32, uint32(LCOLCR_COLC3)}}
}

func (p *DSI_Periph) LCOLCR_LPE() RMLCOLCR {
	return RMLCOLCR{mmio.UM32{&p.LCOLCR.U32, uint32(LCOLCR_LPE)}}
}
...
func (p *DSI_Periph) LPMCR_VLPSIZE() RMLPMCR {
	return RMLPMCR{mmio.UM32{&p.LPMCR.U32, uint32(LPMCR_VLPSIZE)}}
}

func (p *DSI_Periph) LPMCR_LPSIZE() RMLPMCR {
	return RMLPMCR{mmio.UM32{&p.LPMCR.U32, uint32(LPMCR_LPSIZE)}}
}
...
func (p *DSI_Periph) GVCIDR_VCID() RMGVCIDR {
...
func (p *DSI_Periph) VMCR_VMT() RMVMCR {
	return RMVMCR{mmio.UM32{&p.VMCR.U32, uint32(VMCR_VMT)}}
}

func (p *DSI_Periph) VMCR_LPVSAE() RMVMCR {
	return RMVMCR{mmio.UM32{&p.VMCR.U32, uint32(VMCR_LPVSAE)}}
}

func (p *DSI_Periph) VMCR_LPVBPE() RMVMCR {
	return RMVMCR{mmio.UM32{&p.VMCR.U32, uint32(VMCR_LPVBPE)}}
}

func (p *DSI_Periph) VMCR_LPVFPE() RMVMCR {
	return RMVMCR{mmio.UM32{&p.VMCR.U32, uint32(VMCR_LPVFPE)}}
}

func (p *DSI_Periph) VMCR_LPVAE() RMVMCR {
	return RMVMCR{mmio.UM32{&p.VMCR.U32, uint32(VMCR_LPVAE)}}
}

func (p *DSI_Periph) VMCR_LPHBPE() RMVMCR {
	return RMVMCR{mmio.UM32{&p.VMCR.U32, uint32(VMCR_LPHBPE)}}
}
...
func (p *DSI_Periph) VMCR_FBTAAE() RMVMCR {
	return RMVMCR{mmio.UM32{&p.VMCR.U32, uint32(VMCR_FBTAAE)}}
}

func (p *DSI_Periph) VMCR_LPCE() RMVMCR {
	return RMVMCR{mmio.UM32{&p.VMCR.U32, uint32(VMCR_LPCE)}}
}
...
func (p *DSI_Periph) VPCR_VPSIZE() RMVPCR {
	return RMVPCR{mmio.UM32{&p.VPCR.U32, uint32(VPCR_VPSIZE)}}
}
...
func (p *DSI_Periph) VCCR_NUMC() RMVCCR {
	return RMVCCR{mmio.UM32{&p.VCCR.U32, uint32(VCCR_NUMC)}}
}
...
func (p *DSI_Periph) VNPCR_NPSIZE() RMVNPCR {
	return RMVNPCR{mmio.UM32{&p.VNPCR.U32, uint32(VNPCR_NPSIZE)}}
}
...
func (p *DSI_Periph) VHSACR_HSA() RMVHSACR {
	return RMVHSACR{mmio.UM32{&p.VHSACR.U32, uint32(VHSACR_HSA)}}
}
...
func (p *DSI_Periph) VHBPCR_HBP() RMVHBPCR {
	return RMVHBPCR{mmio.UM32{&p.VHBPCR.U32, uint32(VHBPCR_HBP)}}
}
...
func (p *DSI_Periph) VLCR_HLINE() RMVLCR {
	return RMVLCR{mmio.UM32{&p.VLCR.U32, uint32(VLCR_HLINE)}}
}
...
func (p *DSI_Periph) VVSACR_VSA() RMVVSACR {
	return RMVVSACR{mmio.UM32{&p.VVSACR.U32, uint32(VVSACR_VSA)}}
}
...
func (p *DSI_Periph) VVBPCR_VBP() RMVVBPCR {
	return RMVVBPCR{mmio.UM32{&p.VVBPCR.U32, uint32(VVBPCR_VBP)}}
}
...
func (p *DSI_Periph) VVFPCR_VFP() RMVVFPCR {
	return RMVVFPCR{mmio.UM32{&p.VVFPCR.U32, uint32(VVFPCR_VFP)}}
}
...
func (p *DSI_Periph) VVACR_VA() RMVVACR {
	return RMVVACR{mmio.UM32{&p.VVACR.U32, uint32(VVACR_VA)}}
}
...
func (p *DSI_Periph) GHCR_VCID() RMGHCR {
	return RMGHCR{mmio.UM32{&p.GHCR.U32, uint32(GHCR_VCID)}}
}
...
func (p *DSI_Periph) TDCR_V3DM() RMTDCR {
	return RMTDCR{mmio.UM32{&p.TDCR.U32, uint32(TDCR_V3DM)}}
}

func (p *DSI_Periph) TDCR_V3DF() RMTDCR {
	return RMTDCR{mmio.UM32{&p.TDCR.U32, uint32(TDCR_V3DF)}}
}

func (p *DSI_Periph) TDCR_SVS() RMTDCR {
	return RMTDCR{mmio.UM32{&p.TDCR.U32, uint32(TDCR_SVS)}}
}

func (p *DSI_Periph) TDCR_RF() RMTDCR {
	return RMTDCR{mmio.UM32{&p.TDCR.U32, uint32(TDCR_RF)}}
}

func (p *DSI_Periph) TDCR_S3DC() RMTDCR {
	return RMTDCR{mmio.UM32{&p.TDCR.U32, uint32(TDCR_S3DC)}}
}
...
func (p *DSI_Periph) CLTCR_LP2HS_TIME() RMCLTCR {
	return RMCLTCR{mmio.UM32{&p.CLTCR.U32, uint32(CLTCR_LP2HS_TIME)}}
}

func (p *DSI_Periph) CLTCR_HS2LP_TIME() RMCLTCR {
	return RMCLTCR{mmio.UM32{&p.CLTCR.U32, uint32(CLTCR_HS2LP_TIME)}}
}
...
func (p *DSI_Periph) DLTCR_LP2HS_TIME() RMDLTCR {
	return RMDLTCR{mmio.UM32{&p.DLTCR.U32, uint32(DLTCR_LP2HS_TIME)}}
}

func (p *DSI_Periph) DLTCR_HS2LP_TIME() RMDLTCR {
	return RMDLTCR{mmio.UM32{&p.DLTCR.U32, uint32(DLTCR_HS2LP_TIME)}}
}
...
func (p *DSI_Periph) VSCR_EN() RMVSCR {
	return RMVSCR{mmio.UM32{&p.VSCR.U32, uint32(VSCR_EN)}}
}
...
func (p *DSI_Periph) LCVCIDR_VCID() RMLCVCIDR {
	return RMLCVCIDR{mmio.UM32{&p.LCVCIDR.U32, uint32(LCVCIDR_VCID)}}
}
...
func (p *DSI_Periph) LCCCR_COLC() RMLCCCR {
	return RMLCCCR{mmio.UM32{&p.LCCCR.U32, uint32(LCCCR_COLC)}}
}

func (p *DSI_Periph) LCCCR_LPE() RMLCCCR {
	return RMLCCCR{mmio.UM32{&p.LCCCR.U32, uint32(LCCCR_LPE)}}
}
...
func (p *DSI_Periph) LPMCCR_VLPSIZE() RMLPMCCR {
	return RMLPMCCR{mmio.UM32{&p.LPMCCR.U32, uint32(LPMCCR_VLPSIZE)}}
}

func (p *DSI_Periph) LPMCCR_LPSIZE() RMLPMCCR {
	return RMLPMCCR{mmio.UM32{&p.LPMCCR.U32, uint32(LPMCCR_LPSIZE)}}
}
...
func (p *DSI_Periph) VMCCR_VMT() RMVMCCR {
	return RMVMCCR{mmio.UM32{&p.VMCCR.U32, uint32(VMCCR_VMT)}}
}

func (p *DSI_Periph) VMCCR_LPVSAE() RMVMCCR {
	return RMVMCCR{mmio.UM32{&p.VMCCR.U32, uint32(VMCCR_LPVSAE)}}
}

func (p *DSI_Periph) VMCCR_LPVBPE() RMVMCCR {
	return RMVMCCR{mmio.UM32{&p.VMCCR.U32, uint32(VMCCR_LPVBPE)}}
}

func (p *DSI_Periph) VMCCR_LPVFPE() RMVMCCR {
	return RMVMCCR{mmio.UM32{&p.VMCCR.U32, uint32(VMCCR_LPVFPE)}}
}

func (p *DSI_Periph) VMCCR_LPVAE() RMVMCCR {
	return RMVMCCR{mmio.UM32{&p.VMCCR.U32, uint32(VMCCR_LPVAE)}}
}

func (p *DSI_Periph) VMCCR_LPHBPE() RMVMCCR {
	return RMVMCCR{mmio.UM32{&p.VMCCR.U32, uint32(VMCCR_LPHBPE)}}
}
...
func (p *DSI_Periph) VMCCR_FBTAAE() RMVMCCR {
	return RMVMCCR{mmio.UM32{&p.VMCCR.U32, uint32(VMCCR_FBTAAE)}}
}

func (p *DSI_Periph) VMCCR_LPCE() RMVMCCR {
	return RMVMCCR{mmio.UM32{&p.VMCCR.U32, uint32(VMCCR_LPCE)}}
}
...
func (p *DSI_Periph) VPCCR_VPSIZE() RMVPCCR {
	return RMVPCCR{mmio.UM32{&p.VPCCR.U32, uint32(VPCCR_VPSIZE)}}
}
...
func (p *DSI_Periph) VCCCR_NUMC() RMVCCCR {
	return RMVCCCR{mmio.UM32{&p.VCCCR.U32, uint32(VCCCR_NUMC)}}
}
...
func (p *DSI_Periph) VNPCCR_NPSIZE() RMVNPCCR {
	return RMVNPCCR{mmio.UM32{&p.VNPCCR.U32, uint32(VNPCCR_NPSIZE)}}
}
...
func (p *DSI_Periph) VHSACCR_HSA() RMVHSACCR {
	return RMVHSACCR{mmio.UM32{&p.VHSACCR.U32, uint32(VHSACCR_HSA)}}
}
...
func (p *DSI_Periph) VHBPCCR_HBP() RMVHBPCCR {
	return RMVHBPCCR{mmio.UM32{&p.VHBPCCR.U32, uint32(VHBPCCR_HBP)}}
}
...
func (p *DSI_Periph) VLCCR_HLINE() RMVLCCR {
	return RMVLCCR{mmio.UM32{&p.VLCCR.U32, uint32(VLCCR_HLINE)}}
}
...
func (p *DSI_Periph) VVSACCR_VSA() RMVVSACCR {
	return RMVVSACCR{mmio.UM32{&p.VVSACCR.U32, uint32(VVSACCR_VSA)}}
}
...
func (p *DSI_Periph) VVBPCCR_VBP() RMVVBPCCR {
	return RMVVBPCCR{mmio.UM32{&p.VVBPCCR.U32, uint32(VVBPCCR_VBP)}}
}
...
func (p *DSI_Periph) VVFPCCR_VFP() RMVVFPCCR {
	return RMVVFPCCR{mmio.UM32{&p.VVFPCCR.U32, uint32(VVFPCCR_VFP)}}
}
...
func (p *DSI_Periph) VVACCR_VA() RMVVACCR {
	return RMVVACCR{mmio.UM32{&p.VVACCR.U32, uint32(VVACCR_VA)}}
}
...
func (p *DSI_Periph) TDCCR_V3DM() RMTDCCR {
	return RMTDCCR{mmio.UM32{&p.TDCCR.U32, uint32(TDCCR_V3DM)}}
}

func (p *DSI_Periph) TDCCR_V3DF() RMTDCCR {
	return RMTDCCR{mmio.UM32{&p.TDCCR.U32, uint32(TDCCR_V3DF)}}
}

func (p *DSI_Periph) TDCCR_SVS() RMTDCCR {
	return RMTDCCR{mmio.UM32{&p.TDCCR.U32, uint32(TDCCR_SVS)}}
}

func (p *DSI_Periph) TDCCR_RF() RMTDCCR {
	return RMTDCCR{mmio.UM32{&p.TDCCR.U32, uint32(TDCCR_RF)}}
}

func (p *DSI_Periph) TDCCR_S3DC() RMTDCCR {
	return RMTDCCR{mmio.UM32{&p.TDCCR.U32, uint32(TDCCR_S3DC)}}
}
