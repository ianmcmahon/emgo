...
const (
	...
	CM_3  BGPFCCR = 0x08 << 0  //  Input color mode CM bit 3.
...
const (
	BLUE_1  OCOLR = 0xFF << 0  //+ BLUE Value.
	GREEN_1 OCOLR = 0xFF << 8  //+ GREEN Value.
	RED_1   OCOLR = 0xFF << 16 //+ Red Value.
	ALPHA_1 OCOLR = 0xFF << 24 //+ Alpha Channel Value.
	BLUE_2  OCOLR = 0x1F << 0  //  BLUE Value.
	GREEN_2 OCOLR = 0x7E0 << 0 //  GREEN Value.
	RED_2   OCOLR = 0xF8 << 8  //  Red Value.
	BLUE_3  OCOLR = 0x1F << 0  //  BLUE Value.
	GREEN_3 OCOLR = 0x3E0 << 0 //  GREEN Value.
	RED_3   OCOLR = 0x7C << 8  //  Red Value.
	ALPHA_3 OCOLR = 0x80 << 8  //  Alpha Channel Value.
	BLUE_4  OCOLR = 0x0F << 0  //  BLUE Value.
	GREEN_4 OCOLR = 0xF0 << 0  //  GREEN Value.
	RED_4   OCOLR = 0x0F << 8  //  Red Value.
	ALPHA_4 OCOLR = 0xF0 << 8  //  Alpha Channel Value.
)
