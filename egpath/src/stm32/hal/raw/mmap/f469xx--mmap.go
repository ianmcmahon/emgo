...
const (
	...
	SRAM1_BASE      uintptr = 0x20000000 // SRAM1(160 KB) base address in the alias region
	SRAM2_BASE      uintptr = 0x20028000 // SRAM2(32 KB) base address in the alias region
	SRAM3_BASE      uintptr = 0x20030000 // SRAM3(128 KB) base address in the alias region
	...
	QSPI_R_BASE     uintptr = 0xA0001000 // QuadSPI registers base address
	SRAM1_BB_BASE   uintptr = 0x22000000 // SRAM1(112 KB) base address in the bit-band region
	SRAM2_BB_BASE   uintptr = 0x22500000 // SRAM2(16 KB) base address in the bit-band region
	SRAM3_BB_BASE   uintptr = 0x22600000 // SRAM3(64 KB) base address in the bit-band region
	...
	FLASH_END       uintptr = 0x081FFFFF // FLASH end address
	...
	CCMDATARAM_END  uintptr = 0x1000FFFF // CCM data RAM end address
...
const (
	...
	ADC123_COMMON_BASE uintptr = APB2PERIPH_BASE + 0x2300
	ADC_BASE           uintptr = ADC123_COMMON_BASE
	...
	DSI_BASE           uintptr = APB2PERIPH_BASE + 0x6C00
)
