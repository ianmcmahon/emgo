...
const (
	...
	TIM8_CC            nvic.IRQ = 46 // TIM8 Capture Compare global interrupt.
	...
	UART7              nvic.IRQ = 82 // UART7 global interrupt.
	UART8              nvic.IRQ = 83 // UART8 global interrupt.
	SPI4               nvic.IRQ = 84 // SPI4 global Interrupt.
	SPI5               nvic.IRQ = 85 // SPI5 global Interrupt.
	SPI6               nvic.IRQ = 86 // SPI6 global Interrupt.
	SAI1               nvic.IRQ = 87 // SAI1 global Interrupt.
	LTDC               nvic.IRQ = 88 // LTDC global Interrupt.
	LTDC_ER            nvic.IRQ = 89 // LTDC Error global Interrupt.
	DMA2D              nvic.IRQ = 90 // DMA2D global Interrupt.
	QUADSPI            nvic.IRQ = 91 // QUADSPI global Interrupt.
	DSI                nvic.IRQ = 92 // DSI global Interrupt.
)
